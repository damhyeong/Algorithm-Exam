...
1 초	256 MB	238556	160963	142418	68.009%
...
int main (void) {
    ...
    while(++currLoop <= loop) {
        ...
        int num1 = parseInt(*tokensPtr++);
        int num2 = parseInt(*tokensPtr++);
        int result = num1 + num2;

        freeTokens(tokens);

        char* currLoopStr = intToStr(currLoop);

        char** resultTkn = (char**)malloc(sizeof(char*) * (3 + 1));
        resultTkn[0] = intToStr(num1);
        resultTkn[1] = intToStr(num2);
        resultTkn[2] = intToStr(result);
        resultTkn[3] = NULL;
        char** resultTknPtr = (char**)resultTkn;



        sb->append(sb, "Case #")
            ->append(sb, currLoopStr)
            ->append(sb, ": ")
            ->append(sb, *resultTknPtr);
        resultTknPtr++;
        sb->append(sb, " + ")
            ->append(sb, *resultTknPtr);
        resultTknPtr++;
